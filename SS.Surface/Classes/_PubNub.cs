...
//
//        private const string BaseUrl = "pubsub.pubnub.com";
...
//                string_to_sign
//                    .Append(this._publishKey)
//                    .Append('/')
//                    .Append(this._subscribeKey)
//                    .Append('/')
//                    .Append(this._secretKey)
//                    .Append('/')
//                    .Append(channel)
//                    .Append('/')
