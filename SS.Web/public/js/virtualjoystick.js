var VirtualJoystick = function (opts) {
    ...
    this._inputDown = opts.inputDown || function () { };
    this._inputMove = opts.inputMove || function () { };
    this._inputUp = opts.inputUp || function () { };
...
VirtualJoystick.prototype._onUp = function () {
    ...
    this._inputUp({ x: this.deltaX(), y: this.deltaY() });
};
...
VirtualJoystick.prototype._onDown = function(x, y) {
    ...
    this._inputDown({ x: this.deltaX(), y: this.deltaY() });
};
...
VirtualJoystick.prototype._onMove = function (x, y) {
    if (this._pressed === true) {
        ...
        this._stickEl.style.left = (x - this._stickEl.width / 2) + "px";
        this._stickEl.style.top = (y - this._stickEl.height / 2) + "px";
        this._inputMove({ x: this.deltaX(), y: this.deltaY() });
    }
};
...
VirtualJoystick.prototype._onMouseUp = function() {
    return this._onUp();
};
